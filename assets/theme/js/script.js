...
$( ".nav-dropdown .menu-item a" ).addClass( "nav-link link" );

// Live Demo Hover Effect Photo
$(document).ready(function() {

  $('.project .launch_website').mouseenter( function() {
    var portfolioElement;
    portfolioElement = $(this).parent().parent().parent();
    $(this).css('padding', '50px !important');
    $(portfolioElement).find('.project_second_img').css('opacity', '1');
  });

  $('.project .launch_website').mouseleave( function() {
    var portfolioElement;
    portfolioElement = $(this).parent().parent().parent();
    $(this).css('padding', '50px !important');
    $(portfolioElement).find('.project_second_img').css('opacity', '0');
  });
});
